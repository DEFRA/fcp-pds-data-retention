...
const getMappedAgreementNumber = (schemeId, agreementNumber) => {
  ...
  switch (schemeId) {
    case SFI:
      return stringifiedAgreement.padStart(8, '0')
    case CS:
      return 'C' + stringifiedAgreement.padStart(7, '0')
    case COHT_REVENUE:
    case SFI_EXPANDED:
      return 'E' + stringifiedAgreement.padStart(7, '0')
    case COHT_CAPITAL:
      return 'H' + stringifiedAgreement.padStart(7, '0')
    case DELINKED:
    case SFI23:
      return 'Z' + stringifiedAgreement.padStart(7, '0')
    case LUMP_SUMS:
      return 'L' + stringifiedAgreement.padStart(7, '0')
    case SFI_PILOT:
      return 'S' + stringifiedAgreement.padStart(7, '0')
    default:
